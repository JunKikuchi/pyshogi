...
class SenteFu44F_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(True, Fu, self.masume, False)]])
...
class SenteFu44T_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(True, Fu, self.masume, True)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
        self.ugoki  = [
...
class GoteFu44F_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(False, Fu, self.masume, False)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
        self.ugoki  = [((4, 5), None)]
...
class GoteFu44T_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(False, Fu, self.masume, True)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
        self.ugoki  = [
                                        ((4, 3), None),
                        ((5, 4), None),                 ((3, 4), None),
...
class SenteKyosya44F_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(True, Kyosya, self.masume, False)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
        self.ugoki  = [
                        ((4, 3), None),
                        ((4, 2), [False, True]),
...
class SenteKyosya44T_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(True, Kyosya, self.masume, True)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
        self.ugoki  = [
                        ((5, 3), None), ((4, 3), None), ((3, 3), None),
                        ((5, 4), None),                 ((3, 4), None),
...
class GoteKyosya44F_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(False, Kyosya, self.masume, False)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
        self.ugoki  = [
                        ((4, 5), None),
                        ((4, 6), [False, True]),
...
class GoteKyosya44T_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(False, Kyosya, self.masume, True)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
        self.ugoki  = [
                                        ((4, 3), None),
                        ((5, 4), None),                 ((3, 4), None),
...
class SenteKeima44F_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(True, Keima, self.masume, False)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
...
class GoteKeima44F_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(False, Keima, self.masume, False)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
...
class SenteKeima44T_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(True, Keima, self.masume, True)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
        self.ugoki  = [
                        ((5, 3), None), ((4, 3), None), ((3, 3), None),
                        ((5, 4), None),                 ((3, 4), None),
...
class GoteKeima44T_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(False, Keima, self.masume, True)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
        self.ugoki  = [
                                        ((4, 3), None),
                        ((5, 4), None),                 ((3, 4), None),
...
class SenteGin44F_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(True, Gin, self.masume, False)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
        self.ugoki  = [
                        ((5, 3), None), ((4, 3), None), ((3, 3), None),
...
class SenteGin44T_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(True, Gin, self.masume, True)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
        self.ugoki  = [
                        ((5, 3), None), ((4, 3), None), ((3, 3), None),
                        ((5, 4), None),                 ((3, 4), None),
...
class GoteGin44F_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(False, Gin, self.masume, False)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
        self.ugoki  = [
                        ((5, 3), None),                 ((3, 3), None),
...
class GoteGin44T_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(False, Gin, self.masume, True)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
        self.ugoki  = [
                                        ((4, 3), None),
                        ((5, 4), None),                 ((3, 4), None),
...
class SenteKin44F_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(True, Kin, self.masume, False)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
        self.ugoki  = [
                        ((5, 3), None), ((4, 3), None), ((3, 3), None),
                        ((5, 4), None),                 ((3, 4), None),
...
class GoteKin44F_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(False, Kin, self.masume, False)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
        self.ugoki  = [
                                        ((4, 3), None),
                        ((5, 4), None),                 ((3, 4), None),
...
class SenteKaku44F_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(True, Kaku, self.masume, False)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
        self.ugoki  = [
...
class SenteKaku44T_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(True, Kaku, self.masume, True)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
        self.ugoki  = [
                        ((8, 0), None),                 ((0, 0), None),
                        ((7, 1), None),                 ((1, 1), None),
...
class GoteKaku44F_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(False, Kaku, self.masume, False)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
        self.ugoki  = [
                        ((8, 0), None),          ((0, 0), None),
                        ((7, 1), None),          ((1, 1), None),
...
class GoteKaku44T_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(False, Kaku, self.masume, True)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
        self.ugoki  = [
                        ((8, 0), None),                 ((0, 0), None),
                        ((7, 1), None),                 ((1, 1), None),
...
class SenteHisya44F_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(True, Hisya, self.masume, False)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
        self.ugoki  = [
                        ((4, 0), [False, True]),
                        ((4, 1), [False, True]),
...
class SenteHisya44T_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(True, Hisya, self.masume, True)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
        self.ugoki  = [
                        ((4, 0), None),
                        ((4, 1), None),
...
class GoteHisya44F_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(False, Hisya, self.masume, False)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
        self.ugoki  = [
                        ((4, 0), None),
                        ((4, 1), None),
...
class GoteHisya44T_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(False, Hisya, self.masume, True)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
        self.ugoki  = [
                        ((4, 0), None),
                        ((4, 1), None),
...
class SenteGyoku44T_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(True, Gyoku, self.masume, False)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
        self.ugoki  = [
                        ((5, 3), None), ((4, 3), None), ((3, 3), None),
                        ((5, 4), None),                 ((3, 4), None),
...
class GoteGyoku44T_TestCase(unittest.TestCase, BanjyoKomaTestCase):
    def setUp(self):
        self.masume = (4, 4)
        self.ban    = pyshogi.Shogiban([True, [(False, Gyoku, self.masume, False)]])
        self.koma   = apply(self.ban.masu, self.masume).koma
        self.ugoki  = [
                        ((5, 3), None), ((4, 3), None), ((3, 3), None),
                        ((5, 4), None),                 ((3, 4), None),
